...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        json_path = 'data/auto_courses.json'  # عدلي المسار لو الملف في مكان تاني
        try:
        ...
        # Delete old Autotronics courses
        deleted, _ = Course.objects.filter(department=DepartmentChoices.AUTOTRONICS).delete()
